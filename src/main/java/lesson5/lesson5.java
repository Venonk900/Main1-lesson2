...
public class HW5 {
    public static void main(String[] args) {
        ...
        employees[0] = new Employee("MALAHOV", "Ivan", "Ivanovich",
                "Top manager", "ivanovii@mail.me", 150000, 45);
        employees[1] = new Employee("ROGOV", "Petr", "Petrovich", "manager",
                "petrovpp@mail.me", 50000, 30);
        employees[2] = new Employee("KOROTKIH", "Sidor", "Sidorovich",
                "manager", "sidorovss@mail.me", 35000, 25);
        employees[3] = new Employee("PUTIN", "Vasilii", "Ivanovich",
                "manager", "pupkinvi@mail.me", 650000, 41);
        employees[4] = new Employee("IVANOV", "Semen", "Semenovich",
